package com.vass.assesment.customer.config;
...
public class SwaggerConfig {
  ...
  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(
      "Customer Micro Service", "Micro service used to manage Customer CRUD operations",
      "1.0", "urn:tos",
  ...
  public Docket api() {
    return new Docket(DocumentationType.SWAGGER_2)
        ...
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.vass.assesment.customer"))
        .build();
  }
}
